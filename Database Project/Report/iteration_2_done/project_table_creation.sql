DROP DATABASE FAST3_DEALERSHIP;
...
FOR EACH ROW
  BEGIN
    ...
    IF NEW.year_manufactured > CURDATE() OR NEW.year_manufactured < '19000101'
    THEN
      SIGNAL SQLSTATE '45000'
      SET MESSAGE_TEXT = 'Invalid year manufactured '+NEW.year_manufactured;
    END IF;
  END $$
